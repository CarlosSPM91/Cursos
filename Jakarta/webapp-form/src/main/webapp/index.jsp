...
<form action="/webapp-form/registro" method="post">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-4">
            <select name="pais" id="pais" class="form-select">
                ...
                <option value="VN" ${param.pais.equals("VN")? "selected":""}>Venezuela</option>
            </select>
        </div>
        <%
            if (errores !=null && errores.containsKey("username")){
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-4">
            <select name="lenguajes" id="lenguajes" multiple class="form-select">
                ...
                <option value="js"${paramValues.lenguajes.stream().anyMatch(v-> v.equals("js")).get()? "selected":""}>JavaStript</option>
    ...
    <div class="row mb-3">
        ...
        <div class="form-check">
            <input type="checkbox" name="habilitar" id="habilitar" checkedclass="form-check-input" checked>
        </div>
    </div>
    <div>
        <div class="row mb-3">
